...
// Variable:
    ...
    // Variable Braced Initialization: // all types of variable declaration will work equally well Insha Allah... // these kinds of initialization also work on other variables. (other types of variables like float double etc. maybe).
        ...
        // int elephant_count; // here cause we didn't stored any value in this variable so the compiler will store a garbage value in this variable... // A variable that is not initialized... // some compilers can put 0 value here maybe...
